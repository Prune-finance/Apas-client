...
import { useUserPayoutTransactions, exportUserPayoutTransactions } from "@/lib/hooks/transactions";
...
export const PayoutsTab = () => {
  ...
  const handleExport = async () => {
    setExporting(true);
    try {
      await exportUserPayoutTransactions({ ...queryParams, currencyCode: activeCurrency });
    } finally {
      setExporting(false);
    }
  };
  ...
  return (
    <>
      ...
      <TableComponent
        rows={<PayoutTransactionTableRows data={transactions} isUser currency={activeCurrency} noLink />}
        loading={loading}
