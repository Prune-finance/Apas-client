...
import {
  useDefaultAccountTransactionsUSD,
...
export const USDBusinessAccountTransactions = ({
  panelValue,
  customStatusOption,
  active,
  setActive,
  ...
  const { transactions, loading, meta } =
    useDefaultAccountTransactionsUSD(param);

  const { infoDetails } = useInfoDetails(meta, currencyType);
