...
export const Transactions = ({
  ...
  const isIssuedAccount = location?.toLowerCase().includes("issued");
  ...
  const handleDownloadAccountStatement = async () => {
    ...
    const urlMap: { [key: string]: string } = {
      ...
      "issued_account": `${baseUrl}/admin/accounts/${accountID}/transactions/statement?date=${startDate}&endDate=${endDate}&currencyCode=${currencyType}`,
    ...
    const payoutAdminUrl =
      payout && isAdminLocation
        ...
        : null;
    console.log(location, payoutAdminUrl);
